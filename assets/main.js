...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-4', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('.image-component.style-1', { style: 'zoom-in-image', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-3', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('.text-component.style-1', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 250, stagger: 250, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-right', speed: 1250, intensity: 10, threshold: 3, delay: 250, replay: false });
		onvisible.add('.container-component.style-1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 125, replay: false });
